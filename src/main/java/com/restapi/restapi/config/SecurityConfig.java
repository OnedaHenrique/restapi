    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers("/filmes/titulo/**").permitAll()
                        .requestMatchers("/filmes/idade/**").permitAll()
                        .requestMatchers("/atores/id/**").permitAll()
                        .requestMatchers("/atores/nome/**").permitAll()
                        .requestMatchers("/atores/nacio/**").permitAll()
